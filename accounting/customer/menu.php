		...
		<div class="col-lg-3 position-relative about-img"  data-aos="fade-up" data-aos-delay="150">
				<div class="list-group ">
				 <a href="#" class="list-group-item list-group-item-action active">Category</a>
				  ...
				  ?>
				 <a href="menu.php?data=<?php echo urlencode($val->name);?>&id=<?php echo $val->category_id;?>" class="list-group-item list-group-item-action "> <i class="bi bi-record-fill"></i> <?php echo $val->name;?></a>
				<?php } ?>
				<br><br>
				<!-- FOR CALCU -->
          ...
          <div class="col-lg-9 " data-aos="fade-up" data-aos-delay="300">
		   <?php if(isset($_GET['added'])){?>
			...
			<div class="row">
			 <?php
			    $cat_id = $_GET['id'];
				$menu = $mysqli->query("SELECT * from pos_items where item_category_id='$cat_id'");
					...
					<div class="card rounded">
						...
						<div class="card-body text-center">
							<div class="ad-title m-auto">
								<img src="../accounts/items/<?php echo $val2->image;?>" width="200px">
							...
							<input type="hidden" value="<?php echo $val2->item_code;?>" name="item_id">
