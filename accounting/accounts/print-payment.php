          ...
          <div class="card">
            <div class="card-body">
			  ...
			  <div class="grid-container">
				<img class="imgcard mCS_img_loaded"  src="../assets/img/blue 2.png" style="width: 100%;">
				<div class="test"> <span>  <?php echo $settings1[0]['title'];?><br>
						  <?php echo $settings1[0]['address'];?>
						  <h6> <?php echo $settings1[0]['contact'];?></h6>
						  <h6>Receipt</h6></span> </div>
			  </div>
              ...
              <H6><B><small>COMPLAINTS FOR LACKING ITEMS MUST BE DOWN IMMEDIATELY WITHIN 15 DAYS UPON RECEIPT OF GOODS, COMPLAINTS MADE AFTER 15 DAYS WILL NOT BE HONORED. PRICES ARE SUBJECT TO CHANGE W/0 PRIOR NOTICE.</small></B></H6>
            </div>
          </div>
