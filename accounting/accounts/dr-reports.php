              ...
              <table class="table  hover-datatable" id="reject-reports">
				...
				?>
                  ...
                  <tr >
					...
					<?php if($val->receipt !=""){?>
					<img src="receipt/<?php echo $val->receipt;?>" width="200px"  data-bs-toggle="modal" data-bs-target="#add-receipt<?php echo $val->transcode;?>">
					<?php } else { ?>
					<button class="btn btn-info btn-sm" data-bs-toggle="modal" data-bs-target="#add-receipt<?php echo $val->transcode;?>"> Upload Receipt </button>
					<?php } ?>
					</td>
                  </tr>
				   <div class="modal fade" id="add-receipt<?php echo $val->transcode;?>" tabindex="-1">
					  ...
					  <div class="modal-content">
						...
						<div class="modal-body">
						 <form class="row g-3" method="post" enctype="multipart/form-data">
							...
							<br>
								<div class="col-12" >
								  <label for="inputNanme4" class="form-label">Receipt: </label>
									<input type="file" class="form-control" name="image" required>
									<input type="hidden" class="form-control" name="transcode" value="<?php echo $val->transcode;?>" required>
									<input type="text" class="form-control" name="image1" value="<?php echo $val->receipt;?>" >
								</div>
							</div>
							<br>
						<div class="modal-footer">
						  <button type="submit" class="btn btn-primary" name="upload-receipt">Upload </button>
