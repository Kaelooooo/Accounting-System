...
if(isset($_POST['submitOrder'])){
	...
	foreach ($orders as $key => $value) {
		...
		$result = $mysqli->query("INSERT INTO pos_order (customer_id , trans_code ,item_code, qty, status , item_price_change,update_price , is_walkin ) VALUES ('$customer_id','$transcode','$item_code','$item_qty','0','$item_price_change','$item_price','$walkin')");
